...
public class Logic
    ...
    static double rightTrianglePerimeter(double l, double w) {

        return l + w + Math.sqrt(l*l+w*w);
    }

    static double rightTriangleArea(double l, double w) {
    ...
    static double sphereSurfaceArea(double r) {
    ...
    static double boxSurfaceArea(double l, double w, double h) {
        return 2*l*h+2*w*h+2*l*w;


    }

    static double boxVolume(double l, double b, double h) {
